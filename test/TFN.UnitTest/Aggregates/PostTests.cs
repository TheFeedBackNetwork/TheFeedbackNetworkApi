...
namespace TFN.UnitTest.Aggregates
{
    public class PostTests
    {
        ...
        public Post make_Post(Guid id, Guid userId, string trackUrl, string text, int likes, Genre genre, IReadOnlyList<string> tags,Instant created, Instant modified)
        {
